/**
 * HTTPS development server for Neural Bard
 * Serves static files and provides API proxy with HTTPS support
 */
...
server.listen(PORT, () => {
    console.log(`🚀 Neural Bard HTTPS development server running on https://localhost:${PORT}`);
    ...
    console.log(`   Your browser will show a security warning because this is a self-signed certificate.`);
